  ...
  <div className={styles.container}>
    ...
    <div className={styles.subWrapper}>
      <div className={styles.sub}>
        <HighlightBGPrimary withPad>.NET</HighlightBGPrimary>
      </div>
      <div className={styles.dotSeparator} />
      <div className={styles.sub}>
        <HighlightBGPrimary withPad>Azure</HighlightBGPrimary>
      </div>
      <div className={styles.dotSeparator} />
      <div className={styles.sub}>
        <HighlightBGPrimary withPad>Integration</HighlightBGPrimary>
      </div>
      <div className={styles.dotSeparator} />
      <div className={styles.sub}>
        <HighlightBGPrimary withPad>CRM</HighlightBGPrimary>
      </div>
    </div>
